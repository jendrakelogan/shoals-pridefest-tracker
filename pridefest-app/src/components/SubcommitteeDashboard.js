...
export default function SubcommitteeDashboard({ subcommittee, onLogout }) {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F8F7F4', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* Header */}
      <div style={{ background: sc.color, padding: '0' }}>
          ...
          <>
            ...
            {categories.map((cat, ci) => (
              <div key={cat.id} className="fade-up" style={{
                ...
                <div style={{
                  display: 'grid',
                  gridTemplateColumns: '1fr 180px 130px 1fr 40px',
                  gap: '0',
                  background: '#F9FAFB',
                    ...
                    <div key={task.id} style={{
                      ...
                      <textarea
                        ...
                        style={{
                          ...
                          outline: 'none', paddingRight: '12px', lineHeight: '1.5',
                        }}
                      />
                      {/* Lead */}
                      <input
                      ...
                      <textarea
                        ...
                        style={{
                          ...
                          outline: 'none', fontStyle: 'italic', lineHeight: '1.5',
                        }}
                      />
                      {/* Delete */}
                      <button
            ...
            {addingCat ? (
              <div className="fade-in" style={{
                ...
                <input
                  ...
                  style={{
                    flex: 1, border: 'none', fontSize: '16px', outline: 'none', color: '#1F2937',
                  }}
                />
                <button
                  onClick={addCategory}
